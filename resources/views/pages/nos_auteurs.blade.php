                            ...
                            <div class="container">
                                <form action="" class="col-lg-4" >
                                    <div class="input-group" style="display: flex; flex-direction: row;">
                                        <input type="text" class="form-control search-wid" placeholder="Chercher votre auteur favorit" aria-describedby="basic-addon3">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-3 prdct-grid" style="padding: 1%;">
                                                ...
                                                <div class="product-fade-wrap">
                                                    ...
                                                    <div class="product-fade-ct">
                                                        <div class="product-fade-control">
                                                            <div class="to-left">
                                                                <a href="page_auteur.html"><i class="fa fa-heart"></i></a>
                                                            </div>
                                            ...
                                            <div class="product-name">
                                                <a href="">Nom complet</a>
                                            </div>
                                            <p>Adresse</p>
                                            <div class="product-price" style="margin-left: 20%;">
